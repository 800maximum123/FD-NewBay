/obj/temp_visual/dice_roll
	icon = 'mods/_fd/dnd_ss13/icons/dice_roll.dmi'
	layer = EFFECTS_ABOVE_LIGHTING_PLANE
	icon_state = "dice_roll"
	duration = 20

/obj/temp_visual/dice_fail
	icon = 'mods/_fd/dnd_ss13/icons/dice_roll.dmi'
	layer = EFFECTS_ABOVE_LIGHTING_PLANE
	icon_state = "dice_failure"
	duration = 10

/obj/temp_visual/dice_fail/super
	icon_state = "dice_true_failure"

/obj/temp_visual/dice_success
	icon = 'mods/_fd/dnd_ss13/icons/dice_roll.dmi'
	layer = EFFECTS_ABOVE_LIGHTING_PLANE
	icon_state = "dice_success"
	duration = 10

/obj/temp_visual/dice_success/super
	icon_state = "dice_true_success"

/*
/obj/proc_holder/spell/targeted/dice_roll
...
/obj/proc_holder/spell/targeted/dice_roll/cast(list/targets, mob/living/user = usr)
//setup
...
//execution
	...
	new /obj/temp_visual/dice_roll(get_turf(user))
	if(do_after(user, 2 SECONDS))
		if(roll > player_stat)
			if(roll >= 90)
				...
				new /obj/temp_visual/dice_fail/super(get_turf(user))
				return TRUE
			...
			new /obj/temp_visual/dice_fail(get_turf(user))
			return TRUE
		if(roll <= player_stat)
			if(roll <= 10)
				...
				new /obj/temp_visual/dice_success/super(get_turf(user))
				return TRUE
			...
			new /obj/temp_visual/dice_success(get_turf(user))
			return TRUE
